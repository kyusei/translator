 ...
 */
class translatorbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "translator@translator";
    public $boxlabel;
    public $depends = array("translator");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/translator/class/translator.class.php";
